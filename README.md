...
-------------------------------------------------------------------------------
shim-unsigned-x64-15-8.el8.src.rpm included with this submission

-------------------------------------------------------------------------------
What patches are being applied and why:
-------------------------------------------------------------------------------
- Bugfix patches are being applied on top of original upstream shim code to
address bugs found since previous versions and be in line with recent CentOS 8
and RHEL 8. Patches have been included inside a shim SRPM and have explanations
...
-------------------------------------------------------------------------------
Yes. Please see grub2-2.02-87.el8_2.src.rpm included in extra-srpms.tar available
at https://users.suse.com/~jsegitz/2020.09_epam_shim/res8/extra-srpms.tar
...
-------------------------------------------------------------------------------
Yes. CVE-2020-15780 and CVE-2019-20908 fixed by these commits have been 
addressed in the SLES Expanded Support platform 8 kernel (in a SRPM provided
within extra-srpms.tar).
...
-------------------------------------------------------------------------------
A docker image of SLES Expanded Support platform 8 ("sles_esp-shim-15-8.el8.tar.gz")
...
- shim-unsigned-x64-15-8.el8.src.rpm is already included inside images's top level directory for convenience

- Rebuild included SRPM as follows:

  $ rpmbuild --define '_topdir /var/tmp/build-shim-unsigned-x64-15-8.el8.src.rpm' --rebuild /shim-unsigned-x64-15-8.el8.src.rpm

- Resulting RPMs may be found under /var/tmp/build-shim-unsigned-x64-15-8.el8.src.rpm/RPMS
...
Source RPM of shim: shim-unsigned-x64-15-8.el8.src.rpm
Source RPMs of glibc, grub2, gnu-efi, kernel, pesign are included into extra-srpms.tar

Public portion of a certificate: sles_es.pem
