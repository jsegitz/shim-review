...
*******************************************************************************
shim-unsigned-x64-16.1-1.el10.src.rpm included with the submission.
...
* October 2023 - NTFS vulnerabilities
  ...
  * CVE-2023-4692
*******************************************************************************
grub2-2.12-29.el10_1 has fixes included and grub,5 in SBAT.
...
*******************************************************************************
It's `grub,5,Free Software Foundation,grub,GRUB_UPSTREAM_VERSION,https://www.gnu.org/software/grub/` for us
...
*******************************************************************************
None for SUSE Liberty Linux 10.
...
To solve this I mirrored them for now on https://ftp.suse.com/pub/projects/security/shim-review/, where you get them without login
...
The kernel src rpm is also available at 
https://src.opensuse.org/jsegitz/shim-review-sll10/media/branch/main/kernel-6.12.0-124.20.1.el10_1.src.rpm

Have an OS image, shim SRPM and shim binary copied alongside Dockerfile before start, then run:

```
$ podman import sll10_os_image.tar.gz sll10_shim_review
...
*******************************************************************************
This is the first submission of SUSE Liberty Linux 10 shim.
...
shim.sll,3,SUSE Liberty Linux,shim,16.1.el10,security@suse.com
```
...
grub.sll,2,SUSE,grub2,2.12-29.el10_1,mailto:security@suse.com
```
...
fwupd-efi.sll10,1,SUSE Liberty Linux,fwupd-efi,1.6-3.el10,mail:security@suse.com
```
...
systemd-stub.sll,1,SUSE Liberty Linux,systemd,257-13.el10-gba20503,mailto:noreply@suse.com
kernel-uki-virt.rhel,1,Red Hat,kernel-uki-virt,6.12.0-124.20.1.el10_1.x86_64,mailto:secalert@redhat.com
kernel-uki-virt.sll,1,SUSE Liberty Linux,kernel-uki-virt,6.12.0-124.20.1.el10_1.x86_64,mailto:security@suse.com
```
...
*******************************************************************************
all_video at_keyboard backtrace blscfg boot btrfs cat chain configfile connectefi cryptodisk echo efifwsetup efinet efi_netfs ext2 
fat font gcry_rijndael gcry_rsa gcry_serpent gcry_sha256 gcry_twofish gcry_whirlpool gfxmenu gfxterm gzio halt 
hfsplus http increment iso9660 jpeg keylayouts linux loadenv loopback lsefi lsefimmap luks lvm mdraid09 
mdraid1x minicmd multiboot2 net normal part_apple part_gpt part_msdos password_pbkdf2 png reboot regexp search 
search_fs_file search_fs_uuid search_label serial sleep syslinuxcfg test tftp usb 
usbserial_common usbserial_ftdi usbserial_pl2303 usbserial_usbdebug video xfs
...
*******************************************************************************
grub2-2.12-29.el10_1.src.rpm included with this submission.
...
*******************************************************************************
Downstream kernel-6.12.0-124.20.1.el10_1 built from Red Hat's sources with an appropriate set of patches to enforce Secure Boot.
