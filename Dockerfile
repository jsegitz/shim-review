...
RUN rpm --define '_topdir /var/tmp/build-shim-unsigned-x64-15.6-1.el8.src.rpm' -ivh /shim-unsigned-x64-15.6-1.el8.src.rpm
RUN sed -i 's/linux32 -B/linux32/g' /var/tmp/build-shim-unsigned-x64-15.6-1.el8.src.rpm/SPECS/shim-unsigned-x64.spec
RUN rpmbuild --define '_topdir /var/tmp/build-shim-unsigned-x64-15.6-1.el8.src.rpm' -ba /var/tmp/build-shim-unsigned-x64-15.6-1.el8.src.rpm/SPECS/shim-unsigned-x64.spec
COPY shimia32.efi /
COPY shimx64.efi /
RUN ls -la /var/tmp/build-shim-unsigned-x64-15.6-1.el8.src.rpm/RPMS/x86_64/
RUN rpm2cpio /var/tmp/build-shim-unsigned-x64-15.6-1.el8.src.rpm/RPMS/x86_64/shim-unsigned-ia32-15.6-1.el8.x86_64.rpm  | cpio -diu
RUN rpm2cpio /var/tmp/build-shim-unsigned-x64-15.6-1.el8.src.rpm/RPMS/x86_64/shim-unsigned-x64-15.6-1.el8.x86_64.rpm | cpio -diu
