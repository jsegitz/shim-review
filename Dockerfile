...
RUN dnf -y install gcc-8.5.0-20.el8 binutils-2.30-123.el8 make-4.2.1-11.el8 elfutils-libelf-devel-0.189-3.el8 git-2.39.3-1.el8_8
RUN dnf -y install openssl-1.1.1k-12.el8_9 openssl-devel-1.1.1k-12.el8_9 pesign-0.112-27.el8_7 dos2unix-7.4.0-3.el8
RUN dnf -y install rpm-build-4.14.3-28.el8_9
